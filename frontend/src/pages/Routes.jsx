...
//             if (optimalPathData) {
//                 setOptimalPath(`The optimal path is from ${arrival} -> ${optimalPathData.city} -> ${departure}`);
//             } else {
//                 setOptimalPath(`The optimal path is ${arrival} -> ${departure}`);
//             }
//         } else {
//             setOptimalPath(`The optimal path is directly from ${arrival} to ${departure}`);
//         }
...
//                     <span className='text-xl'>{optimalPath}</span>
//                 </div>
